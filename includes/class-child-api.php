...
if ( ! class_exists( 'WS_Theme_Wizard_Child_API' ) ) {

	/**
	 * Define WS_Theme_Wizard_Child_API class
	 */
	class WS_Theme_Wizard_Child_API {
...
/**
 * Returns instance of WS_Theme_Wizard_Child_API
 *
 * @param  int    $template_id Template ID from templatemonster.com.
 * @param  string $order_id    Order ID from user order details.
 * @return object
 */
function ws_theme_child_api( $id = null, $slug = null, $name = null ) {
	return WS_Theme_Wizard_Child_API::get_instance( $id, $slug, $name );
}
